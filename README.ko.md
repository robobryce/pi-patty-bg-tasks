...
명령이 돌고 있을 때 **Ctrl+Shift+B**를 누르면 그 자리에서 바로 백그라운드로 넘어갑니다. 에이전트는 알림을 받고, 손가락을 키에서 떼기도 전에 이미 다음 일을 하고 있습니다.
...
| 단축키 | 동작 |
|-------|------|
| **Ctrl+Shift+B** | 현재 프로세스를 백그라운드로 — 에이전트는 계속 작업 (Claude Code의 Ctrl+B에 대응) |
